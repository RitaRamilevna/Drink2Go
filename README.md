# Грейдирование профессии "Фронтенд-разработчик" Проект: Drink2Go
...
Таким образом, вы можете удобно организовать и внедрить сторонние библиотеки в ваш проект, сохраняя их структуру в папке `source/vendor/`.](../../Modul2/2104439-cat-energy-29/Readme.md)
